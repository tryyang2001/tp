...
public class DeleteExerciseCommand extends Command {
    ...
    public static final String MESSAGE_HELP = "delete -- Deletes entry of food or exercise added." + Ui.LS
                 + Ui.FORMAT_HEADER + DeleteExerciseCommand.MESSAGE_COMMAND_FORMAT + Ui.LS
                 + Ui.FORMAT_PLACEHOLDER + DeleteFoodCommand.MESSAGE_COMMAND_FORMAT + Ui.LS;
