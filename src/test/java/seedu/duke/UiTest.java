...
//    }
    ...
    void printCalorieResult_integerInputs_expectStringOnConsole() {
        String expectedTestResult = "Your calorie gained from food is:   500" + lineSeparator() +
                "Your calorie lost from exercise is: 500" + lineSeparator() +
                "Your net calorie intake is: 500" + lineSeparator() +
                "Your calorie to goal is: 700" + lineSeparator() +
                "Percentage to goal: \u001B[32m|████            |  41.7%\u001B[0m" + lineSeparator();
